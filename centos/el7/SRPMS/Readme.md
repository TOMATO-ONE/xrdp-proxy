...
su - builduser
cd ~
#  wget https://github.com/TOMATO-ONE/xrdp-proxy/raw/devel/centos/el7/SRPMS/neutrinordp-gitf7832d6-1.el7.src.rpm
rpm -ivh neutrinordp-gitf7832d6-1.el7.src.rpm
...
QA_RPATHS=0x0001 rpmbuild -ba --clean rpmbuild/SPECS/neutrinordp.spec
 ...
 sudo yum install -y ~/rpmbuild/RPMS/x86_64/neutrinordp-libs-gitf7832d6-1.el7.x86_64.rpm \
   ~/rpmbuild/RPMS/x86_64/neutrinordp-devel-gitf7832d6-1.el7.x86_64.rpm \
 		openssl pam-devel pkgconfig\(fuse\) pkgconfig\(pixman-1\) nasm checkpolicy selinux-policy-devel

# wget https://github.com/TOMATO-ONE/xrdp-proxy/raw/devel/centos/el7/SRPMS/xrdp-0.9.17-1.el7.src.rpm
