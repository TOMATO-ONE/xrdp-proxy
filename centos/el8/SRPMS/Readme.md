...
#  wget https://github.com/TOMATO-ONE/xrdp-proxy/raw/devel/centos/el8/SRPMS/xrdp-0.9.17-1.el8.src.rpm

rpm -ivh xrdp-0.9.17-1.el8.src.rpm

rpmbuild -ba --clean ~/rpmbuild/SPECS/xrdp.spec

```
※2021.09.11 RockyLinux 8.4/Almalinux 8.4/CentOS 8.4 の docker image での build を確認しています。
