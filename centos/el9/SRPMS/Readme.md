# rpmbuild方法
インストール直後の最小インストール構成のAlmaLinux9から以下のコマンドでrpmパッケージを作成できます。  
```
...
#  wget https://github.com/TOMATO-ONE/xrdp-proxy/raw/devel/centos/el9/SRPMS/neutrinordp-git911c4fc-1.el9.src.rpm
rpm -ivh neutrinordp-git911c4fc-1.el9.src.rpm

rpmbuild -ba --clean ~/rpmbuild/SPECS/neutrinordp.spec

sudo dnf install --enablerepo crb -y openssl pam-devel pkgconfig\(fuse3\) pkgconfig\(pixman-1\) nasm checkpolicy selinux-policy-devel \
noopenh264-devel
